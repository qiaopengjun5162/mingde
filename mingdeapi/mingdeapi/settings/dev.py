"""
Django settings for mingdeapi project.
...
SECRET_KEY = 'django-insecure-7b&q$(h_#-r12p&+il(tnp-qu12z9m6gupf8-uiew$4e$5e+41'
...
WSGI_APPLICATION = 'mingdeapi.wsgi.application'
